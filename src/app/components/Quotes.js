...
export default function Quotes() {
    return <div className="flex gap-2 p-6 relative overflow-hidden rounded bg-contain bg-right bg-no-repeat bg-[#d2e0ed] shadow-[0_0_15px_0_#a8b3be] mt-6" style={{backgroundImage: 'url(/assets/priyo-wahyu.webp)'}}>
