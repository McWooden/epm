...
export default function Jumbotron() {
    return <div className="bg-[#111111] sm:bg-contain bg-cover bg-center bg-no-repeat relative" style={{backgroundImage: 'url(/assets/header-img.png)'}}>
        ...
        <div className="flex flex-col gap-2 p-6  min-h-96 container mx-auto justify-center my-16 z-10 relative">
            ...
            <div className="flex flex-col gap-2 sm:flex-row w-full mt-8">
                ...
                <a href="#kontak" className="inline-block px-6 py-3 flex-1 bg-violet-600 text-gray-200 rounded-xl ease-in-out duration-200 hover:bg-violet-500 shadow hover:shadow-lg">Kontak kami</a>
            </div>
        </div>
