    ...
    return <div className="bg-gradient-to-b from-violet-100 to-pink-100 relative mb-12">
        <div className="flex flex-col gap-2 p-6  min-h-96 container mx-auto justify-center my-16">
            ...
            <div className="flex flex-col gap-2 sm:flex-row w-full mt-8">
                <a href="#produk" className="inline-block px-6 py-3 border border-blue-600 text-blue-600 font-semibold rounded-xl hover:border-blue-700 hover:text-blue-700 hover:scale-105 ease-in-out duration-200 hover:z-10 shadow hover:shadow-lg">Lihat Produk</a>
                <a href="#kontak" className="inline-block px-6 py-3 flex-1 bg-violet-600 text-gray-200 rounded-xl hover:scale-105 ease-in-out duration-200 hover:z-10 shadow hover:shadow-lg">Kontak kami</a>
            </div>
        </div>
